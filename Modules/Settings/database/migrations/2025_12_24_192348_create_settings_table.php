...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settings', function (Blueprint $table) {
            ...
            $table->tinyInteger('break_minutes')->default(0);
            $table->tinyInteger('overtime_minutes')->default(30);
            $table->tinyInteger('days_off_limit')->default(5);
            $table->integer('encashment_limit')->default(2);
            $table->tinyInteger('working_days_per_month')->default(20);
            ...
            $table->tinyInteger('grace_period_minutes')->default(15);
